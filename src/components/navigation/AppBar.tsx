...
const AppBarCustom = (props: { siteTheme: Theme }) => {
  ...
  return (
    <>
      <div
        className={`${siteTheme.accentColor} fixed top-0 left-0 right-0 flex justify-between h-10 w-screen`}
      >
      ...
      {menuOpen && (
        <div
          className={`${siteTheme.accentColor} fixed top-10 left-0 right-0 flex justify-between px-4 w-screen`}
        >
          <span className="float-left mr-2 flex items-center">
            <div className="inline-flex">
              <button
